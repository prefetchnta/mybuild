...
Android (GCC 4.9.x ARMv7 -O2 API-14)
    ...
    openssl-1.0.2n          LIB                     https://www.openssl.org/source/
    python-2.7.14           LIB & EXE & SO          https://www.python.org/downloads/
...
Windows (Visual Studio 2010 X86 /MD)
    ...
    libwebp-0.6.1           LIB & DLL (SSE4.1)      https://github.com/webmproject/libwebp/releases
    ...
    pcre-8.41               DLL                     ftp://ftp.csx.cam.ac.uk/pub/software/programming/pcre/
